      ...
      <>
        ...
        <div className="hero-section">
          <div>
            ...
            <span>
              <h1>FLOKIINU</h1>
              <h2> is a Frictionless yeild and Liquidity Generation Protocol.</h2>
          ...
          <footer>
            <div className="social">
              <div className="container flex-column">
                <div className="row-1">
                  <h1>FLOKI INU</h1>
                  <p>The FLOKI INU is a community driven, fair launched DeFi Token. Three simple functions occur during each trade: Reflection, LP Acquisition, & Burn.</p>
                </div>
                <div className="row-2">
